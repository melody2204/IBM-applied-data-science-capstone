...
uniq_Sites = spacex_df['Launch Site'].unique()
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        title='Total success of all launch sites')
        return fig
    else:
        # return the outcomes piechart for a selected site
        fig = px.pie(filtered_df, names='class', 
        title='Total success of launch sites ' + entered_site)
        return fig
...
def get_pie_chart(entered_site, payload):
    ...
    if entered_site == 'ALL':
        ...
        # return the outcomes piechart for a selected site
        data = filtered_df[(spacex_df['Payload Mass (kg)']>=payload[0])
